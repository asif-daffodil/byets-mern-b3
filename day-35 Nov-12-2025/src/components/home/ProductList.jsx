...
const ProductList = () => {
    return (
        <div className="p-4 mx-auto lg:max-w-7xl md:max-w-3xl">
                ...
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="p-2 flex-1 flex flex-col">
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap justify-between gap-2 mt-3">
                                ...
                                <div className="flex items-center gap-0.5">
                                    <svg className="w-3.5 h-3.5 fill-blue-600" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg className="w-3.5 h-3.5 fill-[#CED5D8]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
                                    </svg>
                                    <svg className="w-3.5 h-3.5 fill-[#CED5D8]" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            ...
                            <button type="button" className="text-sm font-medium px-2 cursor-pointer min-h-9 w-full bg-blue-600 hover:bg-blue-700 text-white tracking-wide ml-auto outline-0 border-0 rounded-sm">Add to cart</button>
                        </div>
                    </div>
                </div>
                <div className="bg-white flex flex-col overflow-hidden hover:shadow-md transition-all">
