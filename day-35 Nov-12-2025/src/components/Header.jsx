...
const Header = () => {
    ...
    return (
        <header className="min-h-[60px] tracking-wide relative z-50">
            <section className="bg-[#004d66] min-h-10 px-4 py-2 sm:px-10 flex items-center max-sm:flex-col">
                ...
                <button type="button" className="text-white text-sm max-sm:my-2">
                    ...
                    asif.abir@hotmail.com
                </button>
                <div className="sm:ml-auto text-white">
                    <a href="javscript:void(0)" className="text-white text-sm mr-1">Sign In</a>
                    /
                    <a href="javscript:void(0)" className="text-white text-sm ml-1">Sign Up</a>
                </div>
            </section>
            <div className="flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-[#151d20] lg:gap-y-4 gap-y-6 gap-x-4">
                <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui-white.svg" alt="logo" className="sm:w-[140px] w-[130px]" />
                </a>
                <div id="collapseMenu" className="max-lg:hidden lg:flex! lg:items-center max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 max-lg:before:inset-0 max-lg:before:z-50">
                    <button onClick={handleClick} className="lg:hidden fixed top-2 right-4 z-100 rounded-full bg-white w-9 h-9 flex items-center justify-center border border-gray-100 cursor-pointer">
                    ...
                    <ul className="lg:flex! lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-[#151d20] max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                        ...
                        <li className="">
                            <NavLink to="/" className={({isActive}) => isActive ? "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:after:absolute lg:after:bg-white lg:after:w-full lg:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300" : "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300"}>Home</NavLink>
                        </li>
                        <li className="">
                            <NavLink to="/shop" className={({isActive})=> isActive ? "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:after:absolute lg:after:bg-white lg:after:w-full lg:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300" : "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300"}>Shop</NavLink>
                        </li>
                        <li className="">
                            <NavLink to="/about" className={({isActive})=> isActive ? "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:after:absolute lg:after:bg-white lg:after:w-full lg:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300" : "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300"}>About</NavLink>
                        </li>
                        <li className="">
                            <NavLink to="/contact" className={({isActive})=> isActive ? "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:after:absolute lg:after:bg-white lg:after:w-full lg:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300" : "text-white block text-[15px] font-normal max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300"}>Contact</NavLink>
                        </li>
                    </ul>
                </div>
                <div className="flex items-center max-sm:ml-auto">
                    <ul className="flex space-x-4">
                        <li className="relative px-1 lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-0.5 lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300">
                    ...
                    <button onClick={handleClick} className="lg:hidden ml-6 cursor-pointer">
